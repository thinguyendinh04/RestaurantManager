...
val occupiedTables = listOf(
    Table("Table 1", "Near Window", 4, 3, listOf(), 1200.0, "Unpaid", "12:00", "", "Occupied", "", "", "", 0.0),
    Table("Table 2", "Center Room", 6, 6, listOf(), 2400.0, "Unpaid", "12:30", "", "Occupied", "", "", "", 0.0),
    Table("Table 3", "Outdoor", 4, 4, listOf(), 2000.0, "Paid", "10:00", "13:00", "Occupied", "", "", "", 0.0),
    Table("Table 4", "Corner", 2, 2, listOf(), 500.0, "Unpaid", "11:00", "", "Occupied", "", "", "", 0.0),
    Table("Table 5", "Main Hall", 8, 8, listOf(), 3200.0, "Paid", "09:30", "12:00", "Occupied", "", "", "", 0.0),
    Table("Table 6", "Terrace", 5, 5, listOf(), 1500.0, "Unpaid", "12:45", "", "Occupied", "", "", "", 0.0),
    Table("Table 7", "Private Room", 3, 2, listOf(), 700.0, "Paid", "12:00", "14:30", "Occupied", "", "", "", 0.0),
    Table("Table 8", "By the Bar", 4, 3, listOf(), 1100.0, "Unpaid", "13:00", "", "Occupied", "", "", "", 0.0)
)
...
// Mock data for "Booked" tables
val bookedTables = listOf(
